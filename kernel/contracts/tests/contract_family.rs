use agentmage_kernel_contracts::{
    Action, ActionId, ActionKind, ActionState, CONTRACT_SCHEMA_VERSION, ContractError,
    ContractPayload, CorrelationId, ErrorCategory, ErrorId, EvidenceId, EvidenceKind,
...
fn complete_contract_family_preserves_linked_identities() {
    ...
    let packet = WorkPacket {
        ...
        validation_issues: vec![validation_issue.clone()],
