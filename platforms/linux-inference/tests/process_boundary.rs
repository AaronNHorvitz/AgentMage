...
const DOCKER_COLLECTOR_SELF_CHECK: &[u8] = b"{\"accepted_operations\":[\"self-check\",\"validate-observation-stdin\"],\"authority\":\"docker-topology-validation-only\",\"component_id\":\"agentmage-docker-topology-collector\",\"docker_mutation\":false,\"enabled\":false,\"network_egress\":false,\"preflight_contract_version\":2,\"protocol_version\":1}\n";
