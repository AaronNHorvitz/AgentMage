...
COMMANDS: Final = (
    ...
    (
        ...
        "-p",
        "agentmage-kernel-engine",
        "operational_store::tests::version_one_upgrades_through_twelve_with_exact_history",
        "--locked",
    ),
    (
        "cargo",
...
MARKERS: Final = (
    ...
    "version_one_upgrades_through_twelve_with_exact_history ... ok",
...
def expected_report() -> dict[str, Any]:
    return {
        ...
        "operational_store_schema_version": 12,
