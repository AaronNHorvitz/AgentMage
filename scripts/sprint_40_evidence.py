...
SOURCE_PATHS: Final = (
    ...
    "artifacts/sprints/sprint-40/lifecycle-report.json",
...
COMMANDS: Final = (
    ...
    (
        "v0.3-lifecycle-campaign",
        (
            "python3", "scripts/sprint_40_lifecycle.py", "--verify",
            "artifacts/sprints/sprint-40/lifecycle-report.json",
        ),
    ),
...
IMPLEMENTED: Final = {
    ...
    "complete_lifecycle_acceptance": True,
