...
COMMANDS: Final = (
    ...
    (
        "frontier-release-host-coordinator",
        (
            "cargo", "test", "-p", "agentmage-host",
            "frontier_release_coordinator", "--lib", "--locked",
        ),
    ),
    (
...
FOCUSED_COMMANDS: Final = tuple(item[0] for item in COMMANDS[:9])
...
IMPLEMENTED: Final = {
    ...
    "frontier_product_coordinator": True,
    "native_end_to_end_round_trip": True,
    "normal_local_flow_integration": True,
    "durable_round_trip_recovery": True,
...
BLOCKERS: Final = [
    ...
    {"code": "INSTALLED-PROHIBITED-CAPABILITY-SCAN-ABSENT", "owner": "53.1.3.2"},
...
def expected_summary(local_pass: bool = True) -> dict[str, Any]:
    return {
        ...
        "frontier_workflow_integrated": True,
