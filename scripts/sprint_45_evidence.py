...
IMPLEMENTED: Final = {
    ...
    "controlled_package_scaffold_application": True,
...
def build_report(
    ...
    return {
        ...
        "verification_evidence": {
            ...
            "controlled_package_scaffold_application_count": 5 if local_pass else None,
        ...
        "summary": {
            ...
            "controlled_package_scaffold_application_active": local_pass,
...
def expected_verification() -> dict[str, Any]:
    return {
        ...
        "controlled_package_scaffold_application_count": 5,
...
def expected_summary() -> dict[str, Any]:
    return {
        ...
        "production_chat_coding_coordinator_active": False,
        "production_language_service_sandbox_active": False,
        "controlled_package_scaffold_application_active": True,
        "trusted_installed_parent_execution_complete": False,
        "cross_platform_acceptance_passed": False,
        "trusted_package_execution_complete": False,
        "independent_review_present": False,
