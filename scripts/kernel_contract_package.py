...
SOURCE_MEMBERS = {
    ...
    "src/context.rs": "kernel/contracts/src/context.rs",
    "src/conversation.rs": "kernel/contracts/src/conversation.rs",
    "src/diagnostics.rs": "kernel/contracts/src/diagnostics.rs",
    "src/display_link.rs": "kernel/contracts/src/display_link.rs",
    "src/document_control.rs": "kernel/contracts/src/document_control.rs",
    "src/engineering.rs": "kernel/contracts/src/engineering.rs",
    "src/engineering_records.rs": "kernel/contracts/src/engineering_records.rs",
    "src/evidence.rs": "kernel/contracts/src/evidence.rs",
    "src/executive.rs": "kernel/contracts/src/executive.rs",
    "src/frontier.rs": "kernel/contracts/src/frontier.rs",
    "src/frontier_import.rs": "kernel/contracts/src/frontier_import.rs",
    "src/grant.rs": "kernel/contracts/src/grant.rs",
    "src/handoff.rs": "kernel/contracts/src/handoff.rs",
    "src/ids.rs": "kernel/contracts/src/ids.rs",
    "src/lib.rs": "kernel/contracts/src/lib.rs",
    "src/mcp.rs": "kernel/contracts/src/mcp.rs",
    "src/meeting.rs": "kernel/contracts/src/meeting.rs",
    "src/model.rs": "kernel/contracts/src/model.rs",
    "src/model_discovery.rs": "kernel/contracts/src/model_discovery.rs",
    ...
    "src/runtime_artifact.rs": "kernel/contracts/src/runtime_artifact.rs",
    "src/runtime_event.rs": "kernel/contracts/src/runtime_event.rs",
    "src/runtime_run.rs": "kernel/contracts/src/runtime_run.rs",
    "src/serialization.rs": "kernel/contracts/src/serialization.rs",
    "src/structured_source.rs": "kernel/contracts/src/structured_source.rs",
    ...
    "src/workspace_snapshot.rs": "kernel/contracts/src/workspace_snapshot.rs",
