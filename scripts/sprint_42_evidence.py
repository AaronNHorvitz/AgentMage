...
COMMANDS: Final = (
    ...
    (
        ...
        (
            ...
            "repository_safety::tests", "--lib", "--locked", "--", "--include-ignored",
        ),
    ),
...
IMPLEMENTED: Final = {
    ...
    "worktree_lifecycle_state_matrix": True,
    "local_interruption_and_recovery_campaign": True,
    ...
    "fedora_live_repository_fixtures_executed": True,
...
def build_report(
    ...
    return {
        ...
        "verification_evidence": {
            ...
            "worktree_lifecycle_state_matrix": local_pass,
            "local_interruption_and_recovery_campaign": local_pass,
            "fedora_live_repository_fixtures_executed": local_pass,
