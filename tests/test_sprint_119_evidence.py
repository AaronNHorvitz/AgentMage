...
from scripts import sprint_119_evidence as evidence
...
class Sprint119EvidenceTests(unittest.TestCase):
 ...
 def test_overclaims(self):
  for field in("published_read_matrix_complete","at_cat_001_complete","independent_human_review","sprint_gate_closed"):
   value=copy.deepcopy(report());value["verification_evidence"][field]=True;self.assertTrue(self.validate(value))
 def test_external(self):
  for field in("upstream_sprint_118_closed","live_catalog_support","release_approval"):
