...
from scripts import sprint_144_evidence as evidence
...
class Sprint144EvidenceTests(unittest.TestCase):
 ...
 def test_external_claims_cannot_be_invented(self):
  for field in ("native_actual_budget_campaign_complete","sprint_gate_closed"):
