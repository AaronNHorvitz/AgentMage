...
from scripts import sprint_161_evidence as e
...
class T(unittest.TestCase):
 ...
 def test_external_overclaims_fail(self):
  for f in ("native_platform_campaign_complete","clean_device_accessibility_complete","rv39_47_complete","sprint_gate_closed"):
