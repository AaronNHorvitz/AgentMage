...
from scripts import sprint_93_evidence as evidence
...
class Sprint93EvidenceTests(unittest.TestCase):
 ...
 def test_enablement_overclaims(self):
  for field in ("upstream_sprint_92_closed","profile_enablement_complete","release_approval"):
   value=copy.deepcopy(report());value["summary"][field]=True;self.assertTrue(self.validate(value))
 def test_external_evidence_overclaims(self):
  for field in ("all_signatures_verified","all_user_reviews_present"):
