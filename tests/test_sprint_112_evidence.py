...
from scripts import sprint_112_evidence as evidence
...
class Sprint112EvidenceTests(unittest.TestCase):
 ...
 def test_external_overclaims(self):
  for field in ("upstream_sprint_111_closed","live_kubernetes_support","release_approval"):
   value=copy.deepcopy(report());value["summary"][field]=True;self.assertTrue(self.validate(value))
 def test_gate_overclaims(self):
  for field in ("rv25_deployment_complete","rv28_complete","at_dep_001_complete","independent_human_review","sprint_gate_closed"):
