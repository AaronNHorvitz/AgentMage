...
from scripts import sprint_121_evidence as evidence
...
class Sprint121EvidenceTests(unittest.TestCase):
 ...
 def test_overclaims(self):
  for field in("native_lifecycle_complete","signature_timestamp_complete","native_chat_complete","rv01_complete","rv02_complete","rv05_complete","at_win_001_complete","independent_human_review","sprint_gate_closed"):
   value=copy.deepcopy(report());value["verification_evidence"][field]=True;self.assertTrue(self.validate(value))
 def test_external(self):
  for field in("upstream_sprint_120_closed","windows_platform_supported","release_approval"):
