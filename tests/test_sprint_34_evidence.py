...
from scripts import sprint_34_evidence as evidence
...
class Sprint34EvidenceTests(unittest.TestCase):
    def test_local_contract_passes_without_release_overclaim(self) -> None:
        value = report()
    ...
    def test_interface_platform_dependency_review_network_write_and_release_overclaims_fail(
        ...
        mutations = (
            ...
            lambda value: value["implemented_contracts"].update({"signed_v0_2_release": True}),
