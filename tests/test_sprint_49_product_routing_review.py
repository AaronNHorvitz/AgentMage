"""Mutation tests for the Sprint 49 product-routing composition review."""
...
from scripts import sprint_49_product_routing_review as review


class Sprint49ProductRoutingReviewTests(unittest.TestCase):
    def test_contract_and_mutations(self) -> None:
        ...
        self.assertEqual(value["status"], "PASS_LOCAL_COMPOSITION_REVIEW")
        with patch.object(review, "expected", return_value=value):
            ...
            mutations = (
                ...
                lambda changed: changed.update({"enabled_profile_count": 1}),
                lambda changed: changed.update({"automatic_routing_enabled": True}),
