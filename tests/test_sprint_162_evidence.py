...
from scripts import sprint_162_evidence as e
...
class T(unittest.TestCase):
 ...
 def test_external_overclaims_fail(self):
  for f in ("reference_cloud_campaign_complete","clean_device_restore_complete","accessibility_removal_complete","strict_local_restoration_complete","rv39_complete","sprint_gate_closed"):
