...
from scripts import sprint_117_evidence as evidence
...
class Sprint117EvidenceTests(unittest.TestCase):
 ...
 def test_overclaims(self):
  for field in("published_read_matrices_complete","at_obs_001_complete","independent_human_review","sprint_gate_closed"):
   value=copy.deepcopy(report());value["verification_evidence"][field]=True;self.assertTrue(self.validate(value))
 def test_external(self):
  for field in("upstream_sprint_116_closed","live_provider_support","release_approval"):
