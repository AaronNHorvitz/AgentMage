...
from scripts.d027_s12_state_evidence import SPEC
from scripts.revision_evidence import expected_commands, validate_report, validate_sources


class D027S12StateEvidenceTests(unittest.TestCase):
    def sources(self):
    ...
    def test_document_and_each_campaign_source_mutations_fail(self):
    ...
    def test_claim_command_revision_and_limit_mutations_fail(self):
        mutations = []
        changed = self.report()
        changed["claims"]["unverified_success_count"] = 1
