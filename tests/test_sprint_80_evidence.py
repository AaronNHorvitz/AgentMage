...
from scripts import sprint_80_evidence as evidence
...
class Sprint80EvidenceTests(unittest.TestCase):
    ...
    def test_external_overclaims_are_rejected(self) -> None:
        for field in (
            "upstream_sprint_79_closed", "live_mcp_transport_complete",
            "native_security_evidence_complete", "independent_review_present", "release_approval",
        ):
    ...
    def test_runtime_overclaims_are_rejected(self) -> None:
        for field in ("live_server_exercised", "native_security_evidence_complete", "independent_review"):
            value = copy.deepcopy(report())
