...
from scripts import sprint_157_evidence as e
...
class T(unittest.TestCase):
 ...
 def test_claims(self):
  for f in ("native_topology_campaign_complete","signed_manifest_complete","independent_review_complete","sprint_gate_closed"):
   v=copy.deepcopy(report());v["verification_evidence"][f]=True;self.assertTrue(self.val(v))
 def test_promotion(self):v=copy.deepcopy(report());v["summary"]["support_promotion_count"]=1;self.assertTrue(self.val(v))
