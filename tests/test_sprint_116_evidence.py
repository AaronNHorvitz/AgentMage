...
from scripts import sprint_116_evidence as evidence
...
class Sprint116EvidenceTests(unittest.TestCase):
 ...
 def test_overclaims(self):
  for field in("rv27_complete","rv29_complete","at_obs_001_complete","independent_human_review","sprint_gate_closed"):
   value=copy.deepcopy(report());value["verification_evidence"][field]=True;self.assertTrue(self.validate(value))
 def test_external(self):
  for field in("upstream_sprint_115_closed","live_telemetry_support","release_approval"):
