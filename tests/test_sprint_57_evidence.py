...
from scripts import sprint_57_evidence as evidence
...
class Sprint57EvidenceTests(unittest.TestCase):
    ...
    def test_valid_local_report_preserves_blocked_sprint_truth(self) -> None:
        ...
        self.assertTrue(value["summary"]["controlled_writer_path_integrated"])
        self.assertTrue(value["summary"]["local_renderer_integrated"])
    ...
    def test_command_source_security_blocker_and_effect_drift_fails(self) -> None:
        mutations = (
            ...
            lambda value: value["verification_evidence"].update({"invented_citation_count": 1}),
            lambda value: value["verification_evidence"].update({"invented_acronym_expansion_count": 1}),
        )
