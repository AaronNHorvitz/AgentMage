...
from scripts import sprint_109_evidence as evidence
...
class Sprint109EvidenceTests(unittest.TestCase):
 ...
 def test_provider_overclaims(self):
  for field in ("upstream_sprint_108_closed","live_ci_provider_support","release_approval"):
   value=copy.deepcopy(report());value["summary"][field]=True;self.assertTrue(self.validate(value))
 def test_gate_overclaims(self):
  for field in ("at_cic_001_complete","independent_human_review","sprint_gate_closed"):
