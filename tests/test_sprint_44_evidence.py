...
from scripts import sprint_44_evidence as evidence
...
class Sprint44EvidenceTests(unittest.TestCase):
    ...
    def test_valid_local_report_remains_blocked_without_release_claim(self) -> None:
        ...
        self.assertTrue(value["summary"]["local_sprint_44_contract_passed"])
    ...
    def test_every_integration_platform_review_fuzz_and_release_overclaim_fails(self) -> None:
        fields = (
            "upstream_sprint_43_closed",
            "production_planning_coordinator_active",
            "live_reproduction_and_validation_active",
            "production_scope_approval_ui_active",
    ...
    def test_command_skip_source_artifact_security_and_blocker_drift_fails(self) -> None:
        mutations = (
            ...
            lambda value: value["implemented_contracts"].update({
                "production_planning_coordinator": True,
            }),
