...
from scripts import sprint_105_evidence as evidence
...
class Sprint105EvidenceTests(unittest.TestCase):
 ...
 def test_external_overclaims(self):
  for field in ("upstream_sprint_104_closed","live_effect_support","release_approval"):
   value=copy.deepcopy(report());value["summary"][field]=True;self.assertTrue(self.validate(value))
 def test_review_overclaims(self):
  for field in ("rv25_complete","rv26_complete","sprint_gate_closed"):
