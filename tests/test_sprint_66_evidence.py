"""Mutation tests for the truthful Sprint 66 local evidence record."""
...
from scripts import sprint_66_evidence as evidence
...
class Sprint66EvidenceTests(unittest.TestCase):
    ...
    def test_valid_report_preserves_blocked_truth(self) -> None:
        ...
        self.assertTrue(value["summary"]["local_sprint_66_contract_passed"])
        self.assertFalse(value["verification_evidence"]["sprint_gate_closed"])
        self.assertEqual(value["summary"]["sprint_status"], "BLOCKED")

    def test_external_transcription_review_and_release_overclaims_fail(self) -> None:
        for field in (
            "upstream_sprint_65_closed", "native_parser_parity_complete",
            "transcription_metrics_complete", "round_trip_comparison_complete",
    ...
    def test_command_source_blocker_and_effect_drift_fails(self) -> None:
        mutations = (
            ...
            lambda value: value["verification_evidence"].update({"native_parser_platform_count": 1}),
