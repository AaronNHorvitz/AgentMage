...
from scripts import sprint_104_evidence as evidence
...
class Sprint104EvidenceTests(unittest.TestCase):
 ...
 def test_external_overclaims(self):
  for field in ("upstream_sprint_103_closed","native_identity_support","release_approval"):
   value=copy.deepcopy(report());value["summary"][field]=True;self.assertTrue(self.validate(value))
 def test_rv24_and_gate_overclaims(self):
  for field in ("rv24_complete","sprint_gate_closed"):
