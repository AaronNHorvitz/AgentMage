...
from scripts import sprint_111_evidence as evidence
...
class Sprint111EvidenceTests(unittest.TestCase):
 ...
 def test_external_overclaims(self):
  for field in ("upstream_sprint_110_closed","live_security_tool_support","release_approval"):
   value=copy.deepcopy(report());value["summary"][field]=True;self.assertTrue(self.validate(value))
 def test_gate_overclaims(self):
  for field in ("rv19_complete","at_sup_001_complete","at_sec_003_complete","independent_human_review","sprint_gate_closed"):
