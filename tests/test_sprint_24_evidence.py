...
from scripts import sprint_24_evidence as evidence
...
class Sprint24EvidenceTests(unittest.TestCase):
    def test_local_contracts_pass_without_delivery_or_release_overclaim(self) -> None:
        value = report()
