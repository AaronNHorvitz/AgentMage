"""Mutation tests for the truthful Sprint 64 local evidence record."""
...
from scripts import sprint_64_evidence as evidence
...
class Sprint64EvidenceTests(unittest.TestCase):
    ...
    def test_valid_report_preserves_blocked_truth(self) -> None:
        ...
        self.assertTrue(value["summary"]["local_sprint_64_contract_passed"])
        self.assertFalse(value["verification_evidence"]["sprint_gate_closed"])
        self.assertEqual(value["summary"]["sprint_status"], "BLOCKED")

    def test_external_visual_manual_and_release_overclaims_fail(self) -> None:
        for field in (
            "upstream_sprint_63_closed", "native_render_complete", "pixel_diff_complete",
            "cross_platform_acceptance_passed", "accessibility_acceptance_passed",
            "independent_review_present", "manual_fuzzing_complete", "release_approval",
        ):
