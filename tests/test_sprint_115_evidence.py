...
from scripts import sprint_115_evidence as evidence
...
class Sprint115EvidenceTests(unittest.TestCase):
 ...
 def test_overclaims(self):
  for field in("promoted_matrix_complete","at_rel_001_complete","independent_human_review","sprint_gate_closed"):
   value=copy.deepcopy(report());value["verification_evidence"][field]=True;self.assertTrue(self.validate(value))
 def test_external(self):
  for field in("upstream_sprint_114_closed","live_release_support","release_approval"):
