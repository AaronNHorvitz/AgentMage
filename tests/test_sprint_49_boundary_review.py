"""Mutation tests for the Sprint 49 gate-owned boundary review."""
...
from scripts import sprint_49_boundary_review as review


class Sprint49BoundaryReviewTests(unittest.TestCase):
