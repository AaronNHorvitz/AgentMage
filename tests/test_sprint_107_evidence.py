...
from scripts import sprint_107_evidence as evidence
...
class Sprint107EvidenceTests(unittest.TestCase):
 ...
 def test_provider_overclaims(self):
  for field in ("upstream_sprint_106_closed","live_work_provider_support","release_approval"):
   value=copy.deepcopy(report());value["summary"][field]=True;self.assertTrue(self.validate(value))
 def test_gate_overclaims(self):
  for field in ("at_wrk_001_complete","independent_human_review","sprint_gate_closed"):
