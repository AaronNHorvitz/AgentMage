...
from scripts import sprint_94_evidence as evidence
...
class Sprint94EvidenceTests(unittest.TestCase):
 ...
 def test_external_overclaims(self):
  for field in ("upstream_sprint_93_closed","native_isolation_complete","native_cancellation_complete","independent_review_present","release_approval"):
 ...
 def test_observation_overclaims(self):
  for field in ("native_process_cleanup_observed","native_worktree_isolation_observed","independent_review"):
