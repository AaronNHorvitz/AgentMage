...
from scripts.classification_contract_evidence import SPEC
from scripts.revision_evidence import expected_commands, validate_report, validate_sources


class ClassificationContractEvidenceTests(unittest.TestCase):
    def sources(self):
    ...
    def test_document_and_schema_mutations_fail(self):
    ...
    def test_claim_command_revision_and_limit_mutations_fail(self):
        mutations = []
        changed = self.report()
        changed["claims"]["advisory_authority_field_count"] = 1
