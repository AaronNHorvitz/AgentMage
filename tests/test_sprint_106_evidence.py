...
from scripts import sprint_106_evidence as evidence
...
class Sprint106EvidenceTests(unittest.TestCase):
 ...
 def test_support_overclaims(self):
  for field in ("upstream_sprint_105_closed","github_com_supported","ghes_supported","release_approval"):
   value=copy.deepcopy(report());value["summary"][field]=True;self.assertTrue(self.validate(value))
 def test_completion_overclaims(self):
  for field in ("complete_rv49","independent_review","sprint_gate_closed"):
