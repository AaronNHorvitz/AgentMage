...
from scripts import sprint_114_evidence as evidence
...
class Sprint114EvidenceTests(unittest.TestCase):
 ...
 def test_external_overclaims(self):
  for field in("upstream_sprint_113_closed","live_iac_support","release_approval"):
   value=copy.deepcopy(report());value["summary"][field]=True;self.assertTrue(self.validate(value))
 def test_gate_overclaims(self):
  for field in("supported_version_matrix_complete","rv29_complete","at_iac_001_complete","independent_human_review","sprint_gate_closed"):
