...
from scripts import sprint_123_evidence as evidence
...
class Sprint123EvidenceTests(unittest.TestCase):
 ...
 def test_overclaims(self):
  for field in("approved_live_campaign_complete","native_fuzz_complete","prolonged_resource_complete","rv15_17_complete","rv23_29_complete","at_xte_001_complete","independent_red_team_review","remote_route_qualification_complete","sprint_gate_closed"):
   value=copy.deepcopy(report());value["verification_evidence"][field]=True;self.assertTrue(self.validate(value))
 def test_external(self):
  for field in("upstream_sprint_122_closed","provider_support_changed","release_approval"):
