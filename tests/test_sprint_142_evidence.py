...
from scripts import sprint_142_evidence as evidence
...
class Sprint142EvidenceTests(unittest.TestCase):
 ...
 def test_external_claims_cannot_be_invented(self):
  for field in ("native_cross_platform_campaign_complete","sprint_gate_closed"):
