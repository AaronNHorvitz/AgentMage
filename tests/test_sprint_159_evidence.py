...
from scripts import sprint_159_evidence as e
...
class T(unittest.TestCase):
 ...
 def test_external_overclaims_fail(self):
  for f in ("native_platform_campaign_complete","accessibility_campaign_complete","rv36_44_45_complete","sprint_gate_closed"):
