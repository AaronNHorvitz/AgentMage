...
from scripts import sprint_60_evidence as evidence
...
class Sprint60EvidenceTests(unittest.TestCase):
    ...
    def test_valid_local_report_preserves_blocked_sprint_truth(self) -> None:
        ...
        self.assertTrue(value["summary"]["local_sprint_60_contract_passed"])
        self.assertFalse(value["verification_evidence"]["sprint_gate_closed"])
        self.assertFalse(value["verification_evidence"]["ocr_package_admitted"])
    ...
    def test_every_external_platform_manual_and_release_overclaim_fails(self) -> None:
        for field in (
            "upstream_sprint_59_closed",
            "pdf_extraction_product_integrated",
            "external_effects_enabled",
            "cross_platform_acceptance_passed",
            "native_ocr_complete",
            "native_render_complete",
            "redaction_verification_complete",
    ...
    def test_command_source_blocker_and_effect_drift_fails(self) -> None:
        mutations = (
            ...
            lambda value: value["verification_evidence"].update({"ocr_package_admitted": True}),
