...
from scripts import sprint_113_evidence as evidence
...
class Sprint113EvidenceTests(unittest.TestCase):
 ...
 def test_external_overclaims(self):
  for field in ("upstream_sprint_112_closed","live_gitops_support","release_approval"):
   value=copy.deepcopy(report());value["summary"][field]=True;self.assertTrue(self.validate(value))
 def test_gate_overclaims(self):
  for field in ("supported_version_matrix_complete","at_dep_001_complete","independent_human_review","sprint_gate_closed"):
