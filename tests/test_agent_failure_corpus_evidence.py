...
from scripts.agent_failure_corpus_evidence import SPEC
from scripts.revision_evidence import expected_commands, validate_report, validate_sources


class AgentFailureCorpusEvidenceTests(unittest.TestCase):
    def sources(self):
    ...
    def test_document_fixture_and_validator_mutations_fail(self):
    ...
    def test_claim_command_revision_and_limit_mutations_fail(self):
        mutations = []
        changed = self.report()
        changed["claims"]["false_success_expectations"] = 1
