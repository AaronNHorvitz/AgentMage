...
from scripts.reclassification_evidence import SPEC
from scripts.revision_evidence import expected_commands, validate_report, validate_sources


class ReclassificationEvidenceTests(unittest.TestCase):
    def sources(self):
    ...
    def test_document_contract_clearance_and_gate_mutations_fail(self):
    ...
    def test_claim_command_revision_and_limit_mutations_fail(self):
        mutations = []
        changed = self.report()
        changed["claims"]["allowed_crossings_per_permit"] = 2
