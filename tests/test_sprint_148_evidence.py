...
from scripts import sprint_148_evidence as evidence
...
class Sprint148EvidenceTests(unittest.TestCase):
 ...
 def test_external_claims_cannot_be_invented(self):
  for field in ("native_document_campaign_complete","sprint_gate_closed"):
