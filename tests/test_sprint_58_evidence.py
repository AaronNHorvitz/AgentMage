...
from scripts import sprint_58_evidence as evidence
...
class Sprint58EvidenceTests(unittest.TestCase):
    ...
    def test_valid_local_report_preserves_blocked_sprint_truth(self) -> None:
        ...
        self.assertTrue(value["summary"]["local_sprint_58_contract_passed"])
        ...
        self.assertTrue(value["verification_evidence"]["prepared_source_restart_retention"])
        self.assertTrue(value["verification_evidence"]["multi_profile_context_accounting"])
        self.assertTrue(value["verification_evidence"]["hostile_lifecycle_campaign"])
