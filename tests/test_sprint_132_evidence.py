...
from scripts import sprint_132_evidence as evidence
...
class Sprint132EvidenceTests(unittest.TestCase):
 def validate(self,v):
 ...
 def test_upstream_or_promotion_cannot_close(self):
  v=copy.deepcopy(report());v["summary"]["upstream_sprint_131_closed"]=True;self.assertTrue(self.validate(v));v=copy.deepcopy(report());v["summary"]["support_promotion_count"]=1;self.assertTrue(self.validate(v))
