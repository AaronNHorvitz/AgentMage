...
from scripts import sprint_155_evidence as evidence
...
class T(unittest.TestCase):
 ...
 def test_external_claims_fail(self):
  for field in ("native_cross_pack_campaign_complete","strict_local_restoration_complete","independent_review_complete","sprint_gate_closed"):
