...
mod tests {
    ...
    use agentmage_kernel_contracts::{
        ...
        GrantTarget, ModelCancellationProbe, ModelContextPacket, ModelFinishReason,
        ModelMessageRole, ModelProposalKind, ModelResourceReport, ModelRunRequest, ModelRunResult,
        ModelRunTerminalState, ModelStreamId, ModelTokenUsage, ModelToolCallCandidate,
        PathResolutionIntent, PlanId, ProposalId, RollbackPlan, RuntimeApprovalChallenge,
        RuntimeApprovalDisposition, RuntimeApprovalResponse, RuntimeEventCursor,
        ...
        G: BoundedRepositoryInspectionExecutor<WorkingDirectory = LinuxAuthorizedWorkspace>,
    {
        ...
        seal_runtime_approval_challenge(RuntimeApprovalChallenge {
            ...
            presentation: agentmage_kernel_contracts::RuntimeApprovalPresentation {
                tool_id: fixture.definition.tool_id.clone(),
                tool_version: fixture.definition.tool_version.clone(),
                display_name: fixture.definition.display_name.clone(),
                risk_level: fixture.definition.risk_level,
                target_scope: fixture.definition.required_grant.target_scope.clone(),
                arguments: fixture.call.arguments.clone(),
                declared_effects: fixture.definition.declared_effects.clone(),
                single_use: fixture.definition.required_grant.single_use,
                timeout_ms: fixture.definition.timeout_ms,
            },
