...
use agentmage_kernel_contracts::{
    ...
    ExactModelProfile, GrantId, ModelContextPacket, ModelFinishReason, ModelMessage,
    ModelMessageId, ModelMessageRole, ModelProposalKind, ModelResourceReport, ModelRunRequest,
    ModelRunResult, ModelRunTerminalState, ModelStreamId, ModelTokenUsage, ModelToolCallCandidate,
    OperationOutcome, PlanId, PolicyId, PostconditionResult, ReceiptId, RepositorySnapshotId,
    RollbackPlan, RuntimeArtifactKind, RuntimeEvent, RuntimeOperationId, RuntimeOutcome,
    RuntimeRunId, RuntimeRunLimits, RuntimeRunRequest, RuntimeSessionMode, SessionId, StateChange,
    StopCondition, StopConditionKind, Task, TaskId, TaskStatus, ToolCall, ToolCatalogId,
    ToolDefinition, ToolId, ToolResult, VerifierCandidate, VerifierDisposition, VerifierId,
