...
function renderRuntimeSessionBoundary(
  ...
  return [
    ...
    `- Workspace: \`${request.workspace_id}\` (${request.workspace_snapshot_sha256})`,
    ...
    `- Permission: policy \`${request.policy_id}\` (${request.policy_sha256}); approvals cannot mint client authority`,
    "- Offline: strict-local runtime; network access unavailable",
