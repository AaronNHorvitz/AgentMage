...
- The dependency manifest admits no native viewer, renderer, screen capture, provider, or embedded
  content execution.
- The corpus inventories positive, prohibited, invalid, boundary, hostile, and evidence-limit cases.
...
Native screenshot/view campaigns, decoded PNG/JPEG coverage, document/presentation/UI renders,
pixel/accessibility review, Fedora, Ubuntu, Windows 11, and macOS acceptance, provider-backed model
execution, independent review, and manual fuzzing remain blockers. Sprint 65 is **BLOCKED**.
