...
| Reference load campaign | `artifacts/sprints/sprint-50/story-50.2-runtime-load-worker` | Worker-backed 8,196-event journal/publisher run, seven bounded saturation recoveries, 16 verified reopens, and 42 focused isolation, pressure, output, artifact, cancellation, and recovery tests pass on one recorded Fedora host; disposition remains `PARTIAL-PASS` |
