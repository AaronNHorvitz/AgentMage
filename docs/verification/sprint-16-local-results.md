...
campaigns, model-context disclosure handling, independent worker review, and
native macOS XPC evidence also remain open. These are blockers, not waived or
substituted by the passing local contract tests.
