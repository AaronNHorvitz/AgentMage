...
- Source candidate: `fabe3897e7b57ccddb846d87a0bd1c96d8168089`.
...
`~/.local/state/agentmage-codex-coding/runs/2026-09-22-daily-1/executable-matrix-logs`

The daily-use campaign used binaries with these exact digests:

| Binary | SHA-256 |
|---|---|
| `agentmage` | `5fae1a40c7fdb9f3da8b7c85b554d3314568bab2f504122f76b591cdbbcfefb2` |
| `agentmage-host` | `240984a5063067125f289aa98669c6a27804fdc43933cf42aa31f85fdc1e1526` |
...
| Worktree contention | second owner refused in 0.0028 seconds against a 5-second ceiling |
| Cancellation | original owner ended `CANCELLED` in 0.2265 seconds against a 30-second ceiling |
...
| Soak duration | 485.603 seconds against a 900-second ceiling |

The recomputable JSON report and raw per-case streams are retained owner-only at:

`~/.local/state/agentmage-codex-coding/runs/2026-09-22-daily-1/daily-logs`
...
rejection payloads are retained below the same durable run root in `muse-logs`, `muse-rejections`,
`gpt-oss-logs` and `gpt-oss-rejections`. These are passing *failure-handling* results and separate
